...
class DataGrabber:
	...
	def download_comments(self, count):
		...
		comments = {}
		file_c = 0
		for i in range(0, count, self.comments_per_query):
...
if __name__ == "__main__":
	...
	q_info = ["lemma", ["köyhä", "rutiköyhä", "ruti#köyhä", "rahaton", "persaukinen", "pers#aukinen", "vähävarainen", "vähä#varainen", "perseaukinen", "perse#aukinen", "tyhjätasku", "tyhjä#tasku", "pienituloinen", "pieni#tuloinen",  "sossupummi", "sossu#pummi", "saita", "sosiaalipummi", "sosiaali#pummi", "varaton", "eläkeläinen", "pienipalkkainen", "pieni#palkkainen"]]
	address = "http://evex.utu.fi/solr"
	core = "suomi24POS"
	grabber = DataGrabber(query_info=q_info, output_folder="comments_new", address=address, core=core)
